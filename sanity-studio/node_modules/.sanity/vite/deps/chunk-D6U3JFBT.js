...
import {
  ...
  usePortal,
  useToast
} from "./chunk-TVEB3QR2.js";
import {
  require_dist
} from "./chunk-7HUWXEOR.js";
import {
  require_jsx_runtime
} from "./chunk-2S2BDLWD.js";
import {
  require_react
} from "./chunk-VUGSDMPC.js";
import {
  __commonJS,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-S3D7SYSI.js")
});
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$p), filter(t32), map(_temp2$9)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  const {
    ...
    documentType,
    documentId
  } = useDocumentPane(), isCreatingDocument = displayed && !displayed._createdAt, defaultPerspective = useGetDefaultPerspective(), filteredReleases = useFilteredReleases({
    ...
    if (isReleaseDocument(perspective) && isCardinalityOneRelease(perspective)) {
      setParams(
        {
          ...params,
          scheduledDraft: getReleaseIdFromReleaseDocumentId(perspective._id)
        },
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    ...
    displayed && filteredReleases.currentReleases?.map((release_0) => (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(TooltipContent$1, { release: release_0 }), ...getReleaseChipState(release_0), onClick: handlePerspectiveChange(release_0), text: release_0.metadata.title || t2("release.placeholder-untitled-release"), tone: getReleaseTone(release_0), locked: isReleaseScheduledOrScheduling(release_0), contextValues: {
      documentId: displayed?._id || "",
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    beta
  } = useWorkspace(), enhancedObjectDialogEnabled = (0, import_react2.useMemo)(() => beta?.form?.enhancedObjectDialog?.enabled, [beta]), {
    selectedReleaseId,
    selectedPerspectiveName
    ...
    releaseId: selectedReleaseId
  }), [documentType, documentId, actionsPerspective, selectedReleaseId]), actions = (0, import_react2.useMemo)(() => documentActions2(documentActionsProps), [documentActions2, documentActionsProps]), handlePathOpen = (0, import_react2.useCallback)((path) => {
  ...
  }, [onPathOpen, params, setPaneParams, enhancedObjectDialogEnabled]), badges = (0, import_react2.useMemo)(() => documentBadges2({
    schemaType: documentType,
    documentId
  ...
  }, [formStateRef, onProgrammaticFocus, paneRouter, params, ready, enhancedObjectDialogEnabled]), (0, import_jsx_runtime2.jsx)(DocumentPaneContext.Provider, { value: documentPane, children });
});
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  const $ = (0, import_react_compiler_runtime.c)(3), source = useSource();
  let t0;
  return $[0] !== props || $[1] !== source.beta?.eventsAPI?.documents ? (t0 = (0, import_jsx_runtime2.jsx)(DocumentPerspectiveProvider, { children: source.beta?.eventsAPI?.documents ? (0, import_jsx_runtime2.jsx)(DocumentEventsPane, { ...props }) : (0, import_jsx_runtime2.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }) }), $[0] = props, $[1] = source.beta?.eventsAPI?.documents, $[2] = t0) : t0 = $[2], t0;
});
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-XE6MOY6F.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-AHAJXG6Z.js"))
};
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-62TWRWE4.js")),
...
//# sourceMappingURL=chunk-D6U3JFBT.js.map
